defmodule Quadquizaminos.TetrisTest do
  use ExUnit.Case
  import Quadquizaminos.Tetris
  alias Quadquizaminos.Brick
  ...
  test "drops and merges" do
    ...
    %{score: score, bottom: bottom} = Quadquizaminos.Tetris.drop(brick, bottom, :red)
