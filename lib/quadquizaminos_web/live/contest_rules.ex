defmodule QuadquizaminosWeb.ContestRules do
  ...
  def render(assigns) do
    ...
    <h1>Contest Rules</h1>
    <p>
    This contest is organized by and sponsored by sFractal Consulting
    and will take place at the Supply Chain Sandbox
    at RSAC.
    </p>
    <p>
    To enter, just play the game during the contest following the rules on this page
    (eg being elibigle, logging in, within time bounds, etc).
    </p>
    <p>
    Contestants must be RSAC registered attendess to win prizes.
    </p>
    <p>
    The contest is open to all registered RSAC participants
    who are at least 21 years of age or older.
    </p>
    <p>
    ...
    Make sure to finish your game cleanly and you have seen the endgame screen with your score.
    </p>
    <p>
    ...
    <p>
    Contestants must participate in awards ceremony during https://www.rsaconference.com/usa/agenda/session/sipping-bill-of-materials
    to be able to select their prize and win; unless alternative arrangements were made with conference organizer during contest.
    </p>
    <p>
    Winners will select <a href= <%= Routes.live_path(QuadquizaminosWeb.Endpoint, QuadquizaminosWeb.ContestPrizes) %> >prizes</a>
    based on the order they appear on the Contest Scoreboards, rotating thru the 3 scoreboards (points, bricks, questions).
    </p>
    <p>
